...
module BGFX
  ...
  def self.load_lib(path = :libbgfx)
    ffi_lib path
    ...
    attach_function :init, :bgfx_init, [Init.by_ref], :bool
    ...
    attach_function :submit, :bgfx_submit, [:view_id, ProgramHandle.by_ref, :int, :ubyte], :void
    ...
    attach_function :create_vertex_buffer, :bgfx_create_vertex_buffer, [Memory.by_ref, VertexLayout.by_ref, :ushort], VertexBufferHandle.by_ref
    attach_function :set_vertex_buffer, :bgfx_set_vertex_buffer, [:uchar, VertexBufferHandle.by_ref, :uint, :uint], :void
    attach_function :destroy_vertex_buffer, :bgfx_destroy_vertex_buffer, [VertexBufferHandle.by_ref], :void

    attach_function :create_index_buffer, :bgfx_create_index_buffer, [Memory.by_ref, :ushort], IndexBufferHandle.by_ref
    attach_function :set_index_buffer, :bgfx_set_index_buffer, [IndexBufferHandle.by_ref, :uint, :uint], :void
    attach_function :destroy_index_buffer, :bgfx_destroy_index_buffer, [IndexBufferHandle.by_ref], :void

    attach_function :create_shader, :bgfx_create_shader, [Memory.by_ref], ShaderHandle.by_ref
    attach_function :create_program, :bgfx_create_program, [ShaderHandle.by_ref, ShaderHandle.by_ref, :bool], ProgramHandle.by_ref
    attach_function :destroy_program, :bgfx_destroy_program, [ProgramHandle.by_ref], :void

    attach_function :create_texture_2d, :bgfx_create_texture_2d, [:uint, :uint, :bool, :uint, TextureFormat, :uint, Memory.by_ref], TextureHandle.by_ref
    attach_function :set_texture, :bgfx_set_texture, [:uchar, :uniform_handle, TextureHandle.by_ref, :uint], :void
    attach_function :destroy_texture, :bgfx_destroy_texture, [TextureHandle.by_ref], :void
