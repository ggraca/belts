...
module Flecs
  ...
  def self.load_lib(path = :libflecs)
    ffi_lib path
    ...
    [:EcsIsA, :EcsChildOf, :EcsDependsOn, :EcsSlotOf].each do |name|
      attach_variable name, :ecs_entity_t
    end
    ...
    # Pipeline
    attach_function :ecs_get_pipeline, [:ecs_world_tp], :ecs_entity_t
    attach_function :ecs_run_pipeline, [:ecs_world_tp, :ecs_entity_t, :ecs_ftime_t], :void
